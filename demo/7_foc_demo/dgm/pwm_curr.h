...
#define I_SCALE                ((float) ((3.3f / 65536.0f) / SHUNT_RESISTENCE / 20.0f))
...
extern int32_t  phase_a_adc_offset;
extern int32_t  phase_b_adc_offset;
extern int32_t  phase_c_adc_offset;
